...
public class MainPanel extends javax.swing.JFrame implements IBooleanSpectrumListener,IDevStateScalarListener,ActionListener {
  ...
  public MainPanel(boolean runningFromShell) {
    ...
    try {
      ...
      DevStateScalar cleaningState = (DevStateScalar)attList.add(cleaningDevName+"/SweepState");
      cleaningStateViewer.setModel(cleaningState);
      splash.progress(nbDevice++);      
      ...
      VoidVoidCommand startPerm = (VoidVoidCommand)cmdList.add(cleaningDevName+"/StartPermanent");
      startPermanentCommand.setModel(startPerm);
      startPermanentCommand.setText("Start Permanent");
      splash.progress(nbDevice++);

      VoidVoidCommand stopPerm = (VoidVoidCommand)cmdList.add(cleaningDevName+"/StopPermanent");
      stopPermanentCommand.setModel(stopPerm);
      stopPermanentCommand.setText("Stop Permanent");
      splash.progress(nbDevice++);
    ...
    innerPanel.setPreferredSize(new Dimension(580,740));
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        startPermanentCommand = new fr.esrf.tangoatk.widget.command.VoidVoidCommandViewer();
        stopPermanentCommand = new fr.esrf.tangoatk.widget.command.VoidVoidCommandViewer();
        ...
        statePanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Cleaning sweep"));
        statePanel.setLayout(new java.awt.GridBagLayout());

        cleaningStateViewer.setLabel("Cleaning sweep state");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 5, 0);
        statePanel.add(cleaningStateViewer, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        innerPanel.add(statePanel, gridBagConstraints);
        ...
        startPermanentCommand.setText("Start Permanent");
        btnPanel2.add(startPermanentCommand);

        stopPermanentCommand.setText("Stop Permanent");
        btnPanel2.add(stopPermanentCommand);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        commandPanel.add(btnPanel2, gridBagConstraints);
  ...
  public static void main(String args[]) {
    ...
    private fr.esrf.tangoatk.widget.command.VoidVoidCommandViewer startPermanentCommand;
    private javax.swing.JPanel statePanel;
    private fr.esrf.tangoatk.widget.command.VoidVoidCommandViewer stopCommand;
    private fr.esrf.tangoatk.widget.command.VoidVoidCommandViewer stopPermanentCommand;
