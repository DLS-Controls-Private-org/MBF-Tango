...
public class TriggerPanel extends javax.swing.JFrame implements IEnumScalarListener {
  ...
  private EnumScalar dac0;
  private EnumScalar dac1;
  ...
  public TriggerPanel(String devName,String target) {
    ...
    try {
      ...
      EnumScalar dac0Ena = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC0_EN_S");
      dac0EnaEditor.setEnumModel(dac0Ena);
      EnumScalar dac0Blanking = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC0_BL_S");
      dac0BlankingEditor.setEnumModel(dac0Blanking);

      EnumScalar dac1Ena = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC1_EN_S");
      dac1EnaEditor.setEnumModel(dac1Ena);
      EnumScalar dac1Blanking = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC1_BL_S");
      dac1BlankingEditor.setEnumModel(dac1Blanking);
      ...
      dac0 = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC0_HIT");
      dac1 = (EnumScalar)attList.add(devName+"/TRG_"+target+"_DAC1_HIT");
    ...
    dac0.addEnumScalarListener(this);
    dac1.addEnumScalarListener(this);
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        dac0Panel = new javax.swing.JPanel();
        dac1Panel = new javax.swing.JPanel();
        ...
        dac0EnaEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        dac0BlankingEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        dac1EnaEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        dac1BlankingEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        ...
        dac0Panel.setBackground(new java.awt.Color(128, 128, 128));
        dac0Panel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        dac0Panel.setPreferredSize(new java.awt.Dimension(25, 20));

        javax.swing.GroupLayout dac0PanelLayout = new javax.swing.GroupLayout(dac0Panel);
        dac0Panel.setLayout(dac0PanelLayout);
        dac0PanelLayout.setHorizontalGroup(
            dac0PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 23, Short.MAX_VALUE)
        );
        dac0PanelLayout.setVerticalGroup(
            dac0PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac0Panel, gridBagConstraints);

        dac1Panel.setBackground(new java.awt.Color(128, 128, 128));
        dac1Panel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        dac1Panel.setPreferredSize(new java.awt.Dimension(25, 20));

        javax.swing.GroupLayout dac1PanelLayout = new javax.swing.GroupLayout(dac1Panel);
        dac1Panel.setLayout(dac1PanelLayout);
        dac1PanelLayout.setHorizontalGroup(
            dac1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 23, Short.MAX_VALUE)
        );
        dac1PanelLayout.setVerticalGroup(
            dac1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac1Panel, gridBagConstraints);
        ...
        gridBagConstraints.ipadx = 10;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac0EnaEditor, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.ipadx = 10;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac0BlankingEditor, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.ipadx = 10;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac1EnaEditor, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.ipadx = 10;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        sourcesPanel.add(dac1BlankingEditor, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.ipadx = 10;
  ...
  private void disarmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_disarmButtonActionPerformed
    ...
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor dac0BlankingEditor;
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor dac0EnaEditor;
    private javax.swing.JPanel dac0Panel;
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor dac1BlankingEditor;
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor dac1EnaEditor;
    private javax.swing.JPanel dac1Panel;
  ...
  public void enumScalarChange(EnumScalarEvent ese) {
    ...
    if(src==soft) {
      ...
      setColor(dac0Panel,value);      
    } else if(src==dac1) {
      setColor(dac1Panel,value);            
    } else if(src==seq0) {
