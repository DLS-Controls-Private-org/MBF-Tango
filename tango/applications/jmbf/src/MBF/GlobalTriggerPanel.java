...
public class GlobalTriggerPanel extends javax.swing.JFrame implements IEnumScalarListener {
  ...
  public GlobalTriggerPanel() {
    ...
    try {
      ...
      adcVLimitEditor.setModel(adc0Limit);
      NumberScalar adc1Limit = (NumberScalar)attList.add(MainPanel.mfdbkHEpicsDevName+"/ADC_EVENT_LIMIT_S");
      adcHLimitEditor.setModel(adc1Limit);
      NumberScalar dac0Limit = (NumberScalar)attList.add(MainPanel.mfdbkVEpicsDevName+"/DAC_EVENT_LIMIT_S");
      dacVLimitEditor.setModel(dac0Limit);
      NumberScalar dac1Limit = (NumberScalar)attList.add(MainPanel.mfdbkHEpicsDevName+"/DAC_EVENT_LIMIT_S");
      dacHLimitEditor.setModel(dac1Limit);
      EnumScalar seq0State = (EnumScalar)attList.add(MainPanel.mfdbkVEpicsDevName+"/SEQ_TRIGGER_S");
      seqVStateEditor.setEnumModel(seq0State);
      EnumScalar seq1State = (EnumScalar)attList.add(MainPanel.mfdbkHEpicsDevName+"/SEQ_TRIGGER_S");
      seqHStateEditor.setEnumModel(seq1State);
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        adcVLimitEditor = new fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor();
        jSmoothLabel3 = new fr.esrf.tangoatk.widget.util.JSmoothLabel();
        adcHLimitEditor = new fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor();
        jSmoothLabel4 = new fr.esrf.tangoatk.widget.util.JSmoothLabel();
        seqVStateEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        jSmoothLabel5 = new fr.esrf.tangoatk.widget.util.JSmoothLabel();
        seqHStateEditor = new fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor();
        jSmoothLabel8 = new fr.esrf.tangoatk.widget.util.JSmoothLabel();
        dacVLimitEditor = new fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor();
        jSmoothLabel9 = new fr.esrf.tangoatk.widget.util.JSmoothLabel();
        dacHLimitEditor = new fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor();
        ...
        eventPanel.setPreferredSize(new java.awt.Dimension(382, 72));
        eventPanel.setLayout(new java.awt.GridBagLayout());

        jSmoothLabel1.setOpaque(false);
        jSmoothLabel1.setText("V ADC limit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        eventPanel.add(jSmoothLabel1, gridBagConstraints);

        adcVLimitEditor.setOpaque(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        eventPanel.add(adcVLimitEditor, gridBagConstraints);

        jSmoothLabel3.setOpaque(false);
        jSmoothLabel3.setText("H ADC limit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        eventPanel.add(jSmoothLabel3, gridBagConstraints);

        adcHLimitEditor.setOpaque(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        eventPanel.add(adcHLimitEditor, gridBagConstraints);

        jSmoothLabel4.setOpaque(false);
        jSmoothLabel4.setText("V Seq Event");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 2;
        eventPanel.add(jSmoothLabel4, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 3;
        eventPanel.add(seqVStateEditor, gridBagConstraints);

        jSmoothLabel5.setOpaque(false);
        jSmoothLabel5.setText("H Seq event");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        eventPanel.add(jSmoothLabel5, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 1;
        eventPanel.add(seqHStateEditor, gridBagConstraints);

        jSmoothLabel8.setOpaque(false);
        jSmoothLabel8.setText("V DAC limit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        eventPanel.add(jSmoothLabel8, gridBagConstraints);

        dacVLimitEditor.setOpaque(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        eventPanel.add(dacVLimitEditor, gridBagConstraints);

        jSmoothLabel9.setOpaque(false);
        jSmoothLabel9.setText("H DAC limit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        eventPanel.add(jSmoothLabel9, gridBagConstraints);

        dacHLimitEditor.setOpaque(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        eventPanel.add(dacHLimitEditor, gridBagConstraints);
  ...
  public static void main(String args[]) {
    ...
    private fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor adcHLimitEditor;
    private fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor adcVLimitEditor;
    ...
    private fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor dacHLimitEditor;
    private fr.esrf.tangoatk.widget.attribute.NumberScalarWheelEditor dacVLimitEditor;
    ...
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor seqHStateEditor;
    private fr.esrf.tangoatk.widget.attribute.EnumScalarComboEditor seqVStateEditor;
